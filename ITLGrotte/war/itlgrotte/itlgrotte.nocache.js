...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "itlgrotte" because\n';
  ...
  $wnd.__gwt_activeModules['itlgrotte'] = {
    'moduleName' : 'itlgrotte',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/itlgrotte.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['itlgrotte'].superdevmode = true;

  var expectedSuffix = '/itlgrotte.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + itlgrotte + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:itlgrotte';
  var devModeSessionKey = '__gwtDevModeSession:itlgrotte';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/itlgrotte/itlgrotte.nocache.js';
  ...
  $wnd.__gwt_activeModules['itlgrotte'].canRedirect = true;
  $wnd.__gwt_activeModules['itlgrotte'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/itlgrotte?user.agent=' + ua + '&_callback=' + callback;
